...
public class MacedonianLanguageDetector implements LanguageDetector {
    ...
    private static final Set<String> FOREIGN_WORDS = Set.of(
        ...
        // "биле" and "беше" are ordinary Macedonian verb forms, so they are
        // intentionally NOT listed here even though Serbian/Bulgarian use them.
        "је", "су", "стране", "народ", "више", "држава", "изјавио",
