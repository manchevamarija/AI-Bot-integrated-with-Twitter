...
7. Во **Објави** демонстрирај филтер, македонски процент и медиуми.
8. Отвори оригинален X URL за да покажеш дека објавата е реална.
9. Во **Донации** креирај draft и одобри го.
10. Submit демонстрирај само ако е обезбеден валиден Vezilka API key.
